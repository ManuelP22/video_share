           ...
           <div className="xl:w-400 w-20 flex flex-col justify-start mb-10 border-r-2 border-gray-100 xl:border-0 p-3">
                ...
                {!userProfile && (
                    <div className="px-2 py-4 hidden xl:block">
                        <p className="text-gray-400">Inicia Sesion para comentar y comparte videos</p>
                        <div className="pr-4">
                            <GoogleLogin  clientId='' render={(renderProps) => (
                                ...
                                ounded-md 
                                outline-none w-full 
                                mt-3 hover:text-white 
                                hover:bg-[#F51997]" onClick={renderProps.onClick} disabled={renderProps.disabled}>
                                    Iniciar sesion
                                </button>
